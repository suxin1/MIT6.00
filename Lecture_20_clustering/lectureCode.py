...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        '''Find the smallest differences between two point in two cluster'''
    ...
    def maxLinkageDist(self, other):
        '''Find the greatest differences between two point in two cluster'''
...
class ClusterSet(object):
    ...
    def getClusters(self):
        return self.members[:]  # This syntax would return a copy of self.member other then a ref.
